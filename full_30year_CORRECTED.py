#!/usr/bin/env python3
"""
30-Year Rent vs Buy Analysis - CORRECTED VERSION
Properly recalculates monthly savings each year as costs inflate
"""
...
print("="*80)
print("30-YEAR NET WORTH COMPARISON (CORRECTED - Dynamic Monthly Savings)")
print("="*80)
...
# Print header
print(f"{'Year':<6} {'Renting':>15} {'3% Down':>15} {'20% Down':>15} {'Rent Save':>12} {'20% Save':>12}")
print("="*80)
...
for year in range(1, 31):
    ...
    # 3% down baseline (changes each year as prop tax and insurance change)
    ...
    monthly_pmi_this_year = pmi_3_annual / 12

    baseline_monthly = monthly_payment_3pct + monthly_pmi_this_year + \
                      (property_tax / 12) + (home_insurance / 12)

    # Rent for this year
    monthly_rent_this_year = annual_rent / 12

    # 20% down costs for this year
    monthly_20_this_year = monthly_payment_20pct + (property_tax / 12) + (home_insurance / 12)

    # Calculate savings for THIS YEAR
    monthly_savings_rent = baseline_monthly - monthly_rent_this_year
    monthly_savings_20 = baseline_monthly - monthly_20_this_year
    ...
    # INVESTMENT GROWTH (using THIS YEAR'S monthly contribution)
    ...
    # Print year results with monthly savings
    print(f"{year:<6} ${net_worth_rent:>14,.0f} ${net_worth_3:>14,.0f} ${net_worth_20:>14,.0f} " +
          f"${monthly_savings_rent:>11,.0f} ${monthly_savings_20:>11,.0f}")
...
print("\n" + "="*80)
print("NOTE: This version correctly updates monthly savings each year")
print("as costs inflate (property tax, insurance, rent)")
print("="*80)
